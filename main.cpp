...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "Thincoin-seeder\n"
...
static const string mainnet_seeds[] = {"dnsseed.thincointools.com", "dnsseed.thincoinpool.org", "dnsseed.thc.xurious.com", "dnsseed.koin-project.com", "seed-a.thincoin.loshan.co.uk", "dnsseed.thrasher.io", ""};
static const string testnet_seeds[] = {"testnet-seed.thincointools.com", "seed-b.thincoin.loshan.co.uk", "testnet-seed.thc.xurious.com", "dnsseed-testnet.thrasher.io", ""};
static const string *seeds = mainnet_seeds;

extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    db.Add(CService("kjy2eqzk4zwi5zd3.onion", 7814), true);
  }
  do {
